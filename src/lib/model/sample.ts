    ...
    costs: [
      {
        ...
        items: [
          { name: "Rooms commitment", value: { amount: 535_725 }, vatEligible: true },
          { name: "Tourism Dirham", value: { formula: "room_commitment * 20 / 1" }, vatEligible: true },
          { name: "Day Delegate", value: { amount: 90_000 }, vatEligible: true },
          { name: "Room-drop amenity", value: { formula: "room_commitment * 30" }, vatEligible: false },
        ],
      },
      {
        cluster: "Operating",
        items: [
          { name: "F&B Group Dinners", value: { formula: "pax_total * 3 * dinner_cost_pp" }, vatEligible: true },
          { name: "VIP Airport Transfers", value: { amount: 36_000 }, vatEligible: true },
          { name: "Videographer (4k€)", value: { formula: "4000 * eur_to_aed" }, vatEligible: false },
          { name: "Team hotel rooms", value: { amount: 20_000 }, vatEligible: true },
          { name: "Team car rental", value: { amount: 2_500 }, vatEligible: false },
          { name: "Permit fee (10k€)", value: { formula: "10000 * eur_to_aed" }, vatEligible: false },
          { name: "General expenses (5k€)", value: { formula: "5000 * eur_to_aed" }, vatEligible: false },
        ],
      },
    ],
  },
